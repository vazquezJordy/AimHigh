...
class SignUpViewController: UIViewController {
    ...
    func validateFields() -> String? {
        ...
        if  Utilities.isPasswordValid(cleanedPassword) == false {
            ...
            return " please maek sure your password is at least 8 characters, contains a specail character and a number"
        }
...
//                check errors
   ...
   let homeViewController = storyboard?.instantiateViewController(identifier: Constants.Storyboard.homeViewController) as? OpeningGoalsPageTableViewController
